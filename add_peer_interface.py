#!/bin/python3
import os
import add_peer_interface_validate_arguments

add_peer_interface_validate_arguments.validate_command_line_arguments()
...
def generate_interface_config(interface_name,interface_path,interface_address,interface_subnetmask,save_config_prompt,local_listen_port,peer_pubkey,tunnel_ips,tunnel_subnet,peer_ip_or_domain,peer_listen_port,set_keepalive,keepalive_seconds):
    ...
    if peer_ip_or_domain == "" or peer_ip_or_domain == None:
        ...
        peer_ip_or_domain = peer_ip_or_domain
    ...
    if set_keepalive == "no" or set_keepalive == "N" or set_keepalive == "n":
        pass
    else:
        if set_keepalive != "yes" or set_keepalive == None and set_keepalive != "no":
